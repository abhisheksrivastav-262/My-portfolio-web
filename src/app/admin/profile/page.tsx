...
export default function ProfileAdminPage() {
  const [profile, setProfile] = useState<Profile>({
    ...
    headline: "AI Full Stack Web Developer building modern, scalable web apps.",
    about: "Passionate developer specialized in React, Next.js, Node.js, and databases.",
    phone: "+91 8140353442",
    email: "abhisheksrivastav262@gmail.com",
    education: [],
    experience: [],
    skills: [],
    social_links: {},
